...
import { Brain, Home, LayoutDashboard, FileText, CheckSquare } from 'lucide-react';
        ...
        <nav className="fixed top-0 left-0 right-0 h-20 bg-app-bg/80 backdrop-blur-xl border-b border-border-subtle z-50 flex items-center justify-between px-10 transition-colors duration-300">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2 px-3 py-1.5 bg-accent/10 border border-accent/20 rounded-full">
                    ...
                    <span className="text-[10px] font-black text-accent uppercase tracking-widest">AI Hackfest</span>
                </div>
